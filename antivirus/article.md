...
И, конечно же, убедимся, что из одноразового куба нет дороги в Интернет и вообще в локальную сеть:

Не мешает проверить из GUI:

(тут будет скриншот настроек куба)
...
Для пущей убедительности вынесем ярлык эмулятора терминала этого самого куба на рабочий стол:
