...
Задача как задача. Наполовину алгоритмическая, наполовину Java-специфическая. Не слишком простая, но
и не сложная. Ещё раз подубеждаюсь в том, что правильно заданный вопрос – это половина ответа.
